...
class EventsPage extends Component {
  ...
  modalConfirmHandler = () => {
    ...
    const event = { title, price, place, date, description };
    console.log(event);

    const requestBody = {
      query: `
          mutation CreateEvent($title: String!, $desc: String!, $price: Float!, $place: String!, $date: String!) {
            createEvent(eventInput: {title: $title, description: $desc, price: $price, place: $place, date: $date}) {
              _id
              title
              description
              place
      ...
      <React.Fragment>
        ...
        {this.state.selectedEvent && (
          ...
          >
            ...
            {/* <p>{this.state.selectedEvent.place}</p> */}
          </Modal>
        )}
        {this.context.token && (
